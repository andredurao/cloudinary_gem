[![Build Status](https://github.com/andredurao/cloudinary_gem/?branch=version_1_1_7)](https://travis-ci.org/andredurao/cloudinary_gem)
Cloudinary
==========
...
You can also set `use_filename` configuration on cloudinary.yml file.
